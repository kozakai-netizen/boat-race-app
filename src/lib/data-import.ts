...
export function generatePlayerMasterTemplate(): string {
  const headers = ['registration_number', 'player_name', 'grade', 'birth_place', 'birth_date', 'height', 'weight', 'debut_date', 'branch']

  // 住之江によく来る選手のリアルなサンプルデータ（架空だが実際の住之江常連選手風）
  const sampleData = [
    // A1級選手（住之江で活躍する実力者風）
    '3456,峰竜太,A1,大阪府,1985-03-12,168,54,2008-05-01,大阪',
    '3789,平本真之,A1,兵庫県,1987-09-25,172,56,2010-04-15,兵庫',
    '4123,西島義則,A1,福岡県,1982-12-08,170,55,2005-10-01,福岡',

    // A2級選手（住之江でよく見る顔ぶれ風）
    '4567,松井繁,A2,大阪府,1990-06-18,165,53,2012-09-01,大阪',
    '4890,田村隆信,A2,兵庫県,1988-11-30,169,54,2011-03-15,兵庫',
    '5234,上野真之介,A2,京都府,1992-04-22,167,52,2015-07-01,京都',

    // B1級選手（地元関西の中堅選手風）
    '5678,中島孝平,B1,大阪府,1989-01-14,166,53,2013-02-01,大阪',
    '5901,山本雅史,B1,兵庫県,1991-08-07,168,54,2014-11-15,兵庫',
    '6123,池田浩二,B1,京都府,1986-05-29,170,55,2009-12-01,京都',
    '6456,森高一真,B1,和歌山県,1993-02-16,164,51,2016-06-01,和歌山',

    // B2級選手（若手・ベテラン含む住之江常連風）
    '6789,大西英之,B2,大阪府,1995-07-03,162,50,2018-04-01,大阪',
    '7012,岸川圭一,B2,奈良県,1984-10-11,171,56,2007-01-15,奈良'
  ]
